...
const visibleWidth = [26, 26, 26, 96, 52, 52, 52]; 
const visibleHeight = [32, 32, 32, 32, 56, 96, 56]; 

const offsetX = [34, 34, 34, 0, 22, 22, 22]; 
const offsetY = [48 + 16, 48 + 16, 48 + 16, 48 + 16, 40, 0, 40]; 

const objectBlueValues = [4, 0, 7, 14, 12, 13, 8]; 
