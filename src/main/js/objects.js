...
const visibleWidth = [26, 26, 26, 96, 52, 52, 52, 32, 96]; 
const visibleHeight = [32, 32, 32, 32, 56, 96, 56, 32, 32]; 

const offsetX = [34, 34, 34, 0, 22, 22, 22, 34, 0]; 
const offsetY = [48 + 16, 48 + 16, 48 + 16, 48 + 16, 40, 0, 40, 48 + 16, 48 + 16]; 

const objectBlueValues = [4, 0, 7, 14, 8, 12, 13, 15, 16]; 
